...
$images = "SELECT count(id) FROM DIGITAL ORDER by id ASC";
...
if ($page) {
echo '<a href="DIGITAL.php"><button><<</button></a>';//Button for first page [<<]
echo '<a href="DIGITAL.php?page='.$page_down.'"><button><</button></a>';//Button for previous page [<]
} 

for ($i=1;$i<=$pages_total;$i++) {
if(($i==$page+1)) {
echo '<a href="DIGITAL.php?page='.$i.'"><button class="active">'.$i.'</button></a>';//Button for active page, underlined using 'active' class
}
...
echo '<a href="DIGITAL.php?page='.$i.'"><button>'.$i.'</button></a>'; }
} 

if (($page + 1) != $pages_total) {
echo '<a href="DIGITAL.php?page='.$page_up.'"><button>></button></a>';//Button for next page [>]
echo '<a href="DIGITAL.php?page='.$pages_total.'"><button>>></button></a>';//Button for last page [>>]
}
...
$result = mysqli_query($dbCon, "SELECT * FROM DIGITAL ORDER by id ASC LIMIT $offset, $per_page");
