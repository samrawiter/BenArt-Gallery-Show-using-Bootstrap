...
$result=mysqli_query($con, "select * from client where user_id='$session_id'")or die('Error In Session');
...
<form action="upload.php" method="post" class="login100-form validate-form" id="register_form" enctype="multipart/form-data"> <span class="login100-form-title p-b-55">
            UPLOAD IMAGE
          </span>
     <div class="wrap-input100 validate-input m-b-16" data-validate = "Please select the type"> 
    <select name="gall" class="input100" selectpicker">
    ...
    <input class="input100" type="file" name="fileToUpload" id="fileToUpload">
     ...
     <div class="container-login100-form-btn p-t-25">
                ...
                <button class="login100-form-btn" type="submit"  class="button" name="submit" id="reg_btn">Upload</button>
